...
grand_prix_data = {
    ...
    "Australian Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9488_Melbourne_Full Race_kmeans.png'),
    ...
    "Austrian Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9550_Spielberg_Full Race_kmeans.png'),
    ...
    "Bahrain Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9472_Sakhir_Full Race_kmeans.png'),
    ...
    "Belgian Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9574_Spa-Francorchamps_Full Race_kmeans.png'),
    ...
    "British Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9558_Silverstone_Full Race_kmeans.png'),
    ...
    "Canadian Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9531_Montreal_Full Race_kmeans.png'),
    ...
    "Chinese Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9673_Shanghai_Full Race_kmeans.png'),
    ...
    "Dutch Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9582_Zandvoort_Full Race_kmeans.png'),
    ...
    "Emilia Romagna Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9515_Imola_Full Race_kmeans.png'),
    ...
    "Hungarian Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '99566_Hungaroring_Full Race_kmeans.png'),
    ...
    "Japanese Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9496_Suzuka_Full Race_kmeans.png'),
    ...
    "Las Vegas Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9644_Las Vegas_Full Race_kmeans.png'),
    ...
    "Mexican Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9625_Mexico City_Full Race_kmeans.png'),
    ...
    "Miami Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9507_Miami_Full Race_kmeans.png'),
    ...
    "Monaco Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9523_Monte Carlo_Full Race_kmeans.png'),
    ...
    "Qatar Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9655_Lusail_Full Race_kmeans.png'),
    ...
    "São Paulo Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9636_Interlagos_Full Race_kmeans.png'),
    ...
    "Saudi Arabian Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9480_Jeddah_Full Race_kmeans.png'),
    ...
    "Singapore Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9606_Singapore_Full Race_kmeans.png'),
    ...
    "Spanish Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9539_Catalunya_Full Race_kmeans'),
        "image_path_corner": os.path.join(current_dir, 'images', 'Corner', '9606_Catalunya_Corners_kmeans.png'),
        "image_path_straight": os.path.join(current_dir, 'images', 'Straight', '9606_Catalunya_Straights_kmeans.png')
    },
    "United States Grand Prix": {
        "image_path": os.path.join(current_dir, 'images', 'Full', '9617_Austin_Full Race_kmeans.png'),
